...
function App() {
    ...
    const stateTodolists:TodolistType[]= [
    ...
    let [tasks, dispatchTasks] = useReducer(tasksReducer,stateTasks);
    let [todolists, dispatchTodolists] = useReducer(todolistsReducer,stateTodolists)
...
//--------------------таски--------------------------------------
    ...
    function removeTodolist(id: string) {
        ...
        dispatchTasks(removeTaskTodolistAC(id))
    ...
    function addTodolist(title: string) {
        ...
        dispatchTasks(addTodolistsAC(newTodolistId))
    }
